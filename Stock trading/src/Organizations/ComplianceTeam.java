...
public class ComplianceTeam extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        RoleNames.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "Compliance Officer" }));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (p!=null){
            ...
            Role r = new Role("Compliance Officer", roleAdmin.getText(),rolePassword.getText(), roleTask.getText());
