...
public class TradingDepartment extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        RoleNames.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "Brokerage manager", "Exchange Administrator" }));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (p!=null){
            ...
            Role r = new Role("Brokerage Manager", roleAdmin.getText(),rolePassword.getText(), roleTask.getText());
