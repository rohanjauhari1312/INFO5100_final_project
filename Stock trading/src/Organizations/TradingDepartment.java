...
public class TradingDepartment extends javax.swing.JPanel {
    ...
    public TradingDepartment(JPanel userProcessContainer, String organization, RoleDirectory roleDirectoryAT, Admin admin, String text) {
        this.admin=admin;
    ...
    private void initComponents() {
        ...
        RoleNames.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "Trader", "Brokerage manager", "Exchange Administrator" }));
