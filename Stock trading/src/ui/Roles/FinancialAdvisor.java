...
public class FinancialAdvisor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextArea2.setFont(new java.awt.Font("Microsoft New Tai Lue", 2, 12)); // NOI18N
...
//      Stock stock = new Stock(name.getAsString(), price, open, high, low, prevClose);
        ...
        double postMarketChangePercent = jsonObject.get("body").getAsJsonArray().get(i).getAsJsonObject().get("postMarketChangePercent").getAsDouble(); 
